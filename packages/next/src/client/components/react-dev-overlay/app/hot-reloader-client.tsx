...
const turbopackHmr: TurbopackHmr | null = IS_TURBOPACK
  ? new TurbopackHmr()
  : null
...
function handleSuccessfulHotUpdateWebpack(
  ...
  const endMsSinceEpoch = Date.now()
  const latency = endMsSinceEpoch - webpackStartMsSinceEpoch!
  console.log(`[Fast Refresh] done in ${latency}ms`)
  reportHmrLatency(sendMessage, updatedModules, endMsSinceEpoch, Date.now())
